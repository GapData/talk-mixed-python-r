...
As you can see I come from South Africa and I work as a Freelance Data Scientist for Toptal. Toptal is an exclusive talent network for technical specialists. Many companies rely on Toptal freelancers for their most important projects.
...
<div class="align-center" style="font-size: 200%;">
  ...
  <code class="handle">@rstudio</code>
...
<p class="caption">Language ratings (Redmonk, Q1 2018).</p>
</div>
...
- excellent (but sometimes opaque) documentation
- `data.frame` is a native type
- has a `%>%` pipe operator and
- standalone analyses
...
- `DataFrame` available via Pandas and
...
- Provides both high- and low-level interfaces.
...
- An (unofficial) [Docker image](https://hub.docker.com/r/datawookie/rstudio/) is available.

```
docker run -p 8787:8787 datawookie/rstudio
```
...
A Data Scientist should be at least<br><span class="emphasis">conversant</span><br>in<br><span class="emphasis">both</span>.

---

Does it to be an<br><span class="emphasis">exclusive</span><br>relationship?

---

Surely we can<br><span class="emphasis">divide</span><br>our allegiance between<br><span class="emphasis">both</span><br>languages?

---

Why can't we have the<br><span class="emphasis">best</span><br>of<br><span class="emphasis">both</span><br>worlds?

---

<div class="align-center">
  <img src="img/python-r-just-do-it.png" width="60%"><br>
  <i class="fab fa-python"></i> + <i class="fab fa-r-project"></i> $\longrightarrow$ Just do it!
</div>

<aside class="notes">
By liberally mixing R and Python you can literally have your cake and eat it too.
</aside>