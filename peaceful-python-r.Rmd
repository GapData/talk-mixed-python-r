...
<div class="align-center" style="font-size: 200%;">
  ...
  <code class="handle">@projectjupyter</code><br>
...
Then we can have the<br><span class="emphasis">best</span><br>of<br><span class="emphasis">both</span><br>worlds.
...
<aside class="notes">
So, I encourage you to just do it. Liberally mix R and Python. You can have your cake and eat it too.
</aside>